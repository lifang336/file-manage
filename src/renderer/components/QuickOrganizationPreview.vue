      ...
      <div class="preview-stats">
        ...
        <div class="stat-item">
          ...
          <span class="stat-value">{{
            Object.keys(previewData.categorySummary).filter(
              (key) => previewData.categorySummary[key] > 0
            ).length
          }}</span>
        </div>
      </div>
              ...
              <div class="tree-node root">
                <div class="node-content">
                  ...
                  <span class="node-name">{{
                    getDirectoryName(sourceDirectoryPath)
                  }}</span>
                </div>
          ...
          <div class="structure-after">
            ...
            <div class="tree-container">
              <div class="tree-node root">
                ...
                <div class="tree-children">
                  <div
                    v-for="[category, files] in Object.entries(
                      afterStructure
              ...
              >
                ...
                <div class="file-target">
                  ...
                  <span class="target-path">{{
                    getRelativeTargetPath(file.targetPath)
                  }}</span>
                </div>
              </div>
            </div>
...
const getFilesForCategory = (category: string) => {
  ...
  return props.previewData.classifications.filter(
    (file) => file.assignedCategory === category
  );
};

// 获取相对目标路径
const getRelativeTargetPath = (targetPath: string) => {
  if (!props.sourceDirectoryPath) return targetPath;
  const relativePath = targetPath.replace(props.sourceDirectoryPath, "");
